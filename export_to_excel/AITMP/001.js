...
await importMaxScript({fileName: "TEST_SKS_EXCEL_JXLS01.json",logname:"SKS_IMP_MAXAPPINFO"})

await callMaxScript({apiScriptName:"TEST_SKS_EXCEL_JXLS01",fileName: "none.json",logname:"",params:{deleteJson:true}})
