...
<template>
  <div class="parts-application-detail">
    <h1 class="page-title">零件登记申请详情</h1>

    <!-- 父表：申请单头信息 (ITEMRM) -->
    <MaximoSection title="零件登记申请">
      <table class="tdtblw">
        <MaximoSectionRow>
          <!-- 第一列：供应商信息 -->
          <MaximoSectionCol>
            ...
            <MaximoSectionCol>
              <MaximoSection title="基础信息">
                <MaximoSectionRow>
                  ...
                  <MaximoTextbox v-model="partsList[selectedPartIndex].opStatus" label="SOP/EOP" :required="true" width="200px" />
                  </MaximoSectionCol>
                  <MaximoSectionCol>
